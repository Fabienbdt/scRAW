...
DEVICE="${DEVICE:-cpu}"
SEED="${SEED:-42}"
SEARCH_GROUPS="${SEARCH_GROUPS:-baseline,dann}"
MAX_RUNS="${MAX_RUNS:-0}"
...
RUN_NAME="${PRESET}_${DATA_STEM}_dann_focus_metrics_only_${TIMESTAMP}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/results/hparam_search_dann/${RUN_NAME}}"
...
echo "DANN-focused hyperparameter search started in background."
echo "PID: ${PID}"
echo "Output root: ${OUTPUT_ROOT}"
